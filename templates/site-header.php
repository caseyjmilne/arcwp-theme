    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between py-2">
            ...
            <a href="<?php echo home_url('/'); ?>" class="hover:opacity-80 transition-opacity">
                    <!-- Light mode logo -->
                    <svg width="221" height="88" viewBox="0 0 221 88" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-8 w-auto dark:hidden">
                    ...
                    <!-- Dark mode logo -->
                    <svg width="223" height="88" viewBox="0 0 223 88" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-8 w-auto hidden dark:block">
