        ...
        <nav class="flex-1 px-8 pb-8">
            ...
            <div class="mb-8">
                ...
                <div class="flex items-center gap-6">
                    <a href="https://x.com/arcwordpress" target="_blank" rel="noopener noreferrer" class="text-slate-900 dark:text-slate-50 hover:text-orange-600 transition-colors inline-flex">
                    ...
                    <a href="https://www.youtube.com/@arcwordpress" target="_blank" rel="noopener noreferrer" class="text-slate-900 dark:text-slate-50 hover:text-orange-600 transition-colors">
        ...
        <div class="flex flex-col md:flex-row justify-between gap-8 md:gap-12 lg:gap-16 mb-12">
            ...
            <div class="flex-shrink-0">
                ...
                <div class="flex items-center gap-4 order-2">
                    <a href="<?php echo home_url('/'); ?>" class="inline-flex hover:opacity-80 transition-opacity">
                    <!-- Light mode logo -->
