<footer class="border-t border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-50 py-16 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between gap-8 md:gap-12 lg:gap-16 mb-12">
            ...
            <div class="flex-shrink-0">
                ...
                <a href="<?php echo home_url('/'); ?>" class="block hover:opacity-80 transition-opacity">
                    <!-- Light mode logo -->
                    <svg width="221" height="88" viewBox="0 0 221 88" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[160px] h-auto dark:hidden">
                    ...
                    <!-- Dark mode logo -->
                    <svg width="223" height="88" viewBox="0 0 223 88" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[160px] h-auto hidden dark:block">
        ...
        <div class="mt-[100px]">
            ...
            <p class="font-lexend font-normal text-sm text-slate-900 dark:text-slate-50">
