    ...
    <div class="max-w-[1120px] mx-auto px-4">
        <div class="flex flex-col md:flex-row justify-between gap-8 md:gap-12 lg:gap-16 mb-12">
            ...
            <div class="flex-shrink-0">
                <a href="<?php echo esc_url(site_url('/')); ?>" class="text-xs font-black text-white tracking-tight block mb-3">
                    ARCWP
                </a>
                <p class="text-sm text-gray-400 leading-relaxed max-w-xs mb-6">
                    Professional software solutions for WordPress
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-x-6 md:gap-x-8 lg:gap-x-12 gap-y-8 ml-auto min-w-0 md:min-w-[500px] lg:min-w-[700px]">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Themes</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Plugins</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Blocks</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Templates</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-sm hover:text-white transition-colors">E-commerce</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Membership</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Portfolio</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Business</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Tutorials</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Partners</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-sm hover:text-white transition-colors">GitHub</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Changelog</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Roadmap</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-sm hover:text-white transition-colors">License</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Forum</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Events</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Newsletter</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors">Showcase</a></li>
                    </ul>
                </div>
        ...
        <div class="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
                <p class="text-sm text-gray-500 mb-4">
                    &copy; <?php echo date('Y'); ?> ARCWP. All rights reserved.
                </p>
                <div class="flex gap-4">
                    ...
                    <a href="#" class="text-gray-400 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.129 22 16.99 22 12c0-5.523-4.477-10-10-10z" clip-rule="evenodd" />
                        </svg>
                    </a>
                </div>
            </div>
