    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between gap-8 md:gap-12 lg:gap-16 mb-12">
            ...
            <div class="flex-shrink-0">
                ...
                <a href="<?php echo home_url('/'); ?>" class="block hover:opacity-80 transition-opacity">
                    <!-- Light mode logo -->
                    <svg width="221" height="88" viewBox="0 0 221 88" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[180px] h-auto dark:hidden">
                    ...
                    <!-- Dark mode logo -->
                    <svg width="223" height="88" viewBox="0 0 223 88" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[180px] h-auto hidden dark:block">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-x-6 md:gap-x-8 lg:gap-x-12 gap-y-8 ml-auto min-w-0 md:min-w-[500px] lg:min-w-[700px]">
                ...
                <!-- Legal -->
                <div>
                    <h3 class="font-lexend font-semibold text-sm mb-4">Legal</h3>
                    <ul class="space-y-2">
        ...
        <div class="mt-[100px]">
            <div class="flex gap-4 mb-4">
                <a href="https://x.com/arcwordpress" target="_blank" rel="noopener noreferrer" class="text-slate-900 dark:text-slate-50 hover:text-orange-600 transition-colors">
                    <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
                </a>
                <a href="https://github.com/arcwordpress" target="_blank" rel="noopener noreferrer" class="text-slate-900 dark:text-slate-50 hover:text-orange-600 transition-colors">
                    <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <p class="font-lexend font-medium text-sm text-slate-900 dark:text-slate-50">
