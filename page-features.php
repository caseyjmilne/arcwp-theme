    ...
    <section class="py-20 lg:py-32">
        <div class="max-w-[1120px] mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <!-- Left Content -->
                <div>
                    <div class="inline-block bg-black text-white text-xs font-bold px-3 py-1 rounded-full mb-6">
                        ARC SUITE
                    </div>
                    <h1 class="text-5xl lg:text-6xl font-black text-black mb-6 leading-tight">
                    ...
                    <div class="mt-12 flex items-center gap-8">
                        <div>
                            <div class="text-3xl font-black text-black">50K+</div>
                            <div class="text-sm text-gray-500">Active Installs</div>
                        </div>
                        <div>
                            <div class="text-3xl font-black text-black">98%</div>
                    ...
                    <div class="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg overflow-hidden shadow-2xl">
                        <div class="w-full h-full flex items-center justify-center">
                            <div class="text-center p-8">
                                ...
                                <p class="text-gray-500 text-sm font-medium">Hero Image Placeholder<br/>1200 x 900px</p>
                            </div>
                        </div>
                    </div>
                    <!-- Decorative Elements -->
                    <div class="absolute -bottom-6 -right-6 w-32 h-32 bg-black opacity-10 rounded-lg -z-10"></div>
                    <div class="absolute -top-6 -left-6 w-24 h-24 border-4 border-black opacity-20 rounded-lg -z-10"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 lg:py-32 bg-white">
        <div class="max-w-[1120px] mx-auto px-4">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
                ...
                <!-- Feature 1: Speed -->
                <div>
                    <div class="text-7xl lg:text-8xl font-black text-black mb-4 leading-none">
                        01
                    </div>
        ...
        <div class="relative max-w-[1120px] mx-auto px-4 py-20 lg:py-32">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="#" class="group inline-flex items-center justify-center bg-white text-black px-8 py-4 rounded-full text-base font-bold hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl hover:scale-105">
                        Get Started Free
                        <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                        </svg>
                    </a>
                    <a href="#" class="inline-flex items-center justify-center text-white px-8 py-4 text-base font-medium hover:text-gray-300 transition-colors">
                        View Demo
                ...
                <div class="mt-12 pt-8 border-t border-white/10">
                    <p class="text-sm text-gray-400 mb-4">Trusted by developers worldwide</p>
                    <div class="flex justify-center items-center gap-8 flex-wrap">
                        ...
                        <div class="text-white font-semibold">50,000+ <span class="text-gray-400 font-normal">installs</span></div>
                        <div class="text-gray-400">•</div>
                        <div class="text-white font-semibold">24/7 <span class="text-gray-400 font-normal">support</span></div>
                    </div>
                </div>
            </div>
        </div>
