    ...
    <section class="py-20 lg:py-32">
        <div class="max-w-[1120px] mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <!-- Left Content -->
                <div>
                    <div class="inline-block text-gray-100 text-xs font-bold px-3 py-1 rounded-full mb-6 border border-gray-500">
                        ARC SUITE
                    </div>
                    <h1 class="text-5xl lg:text-6xl font-black text-gray-400 mb-6 leading-tight">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo site_url('packages'); ?>" class="inline-flex items-center justify-center bg-sky-800 text-white px-8 py-4 rounded-md text-sm font-medium hover:bg-sky-900 transition-colors">
                            Get Started Free
                        </a>
                        <a href="<?php echo site_url('docs'); ?>" class="inline-flex items-center justify-center border-2 border-zinc-900 text-gray-400 px-8 py-4 rounded-md text-sm font-medium hover:bg-black hover:text-gray-200 transition-colors">
                            View Documentation
                        </a>
                    </div>
                    <div class="mt-12 flex items-center gap-8">
                        <div>
                            <div class="text-3xl font-black text-gray-400">24/7</div>
                ...
                <div class="relative">
                    ...
                    <!-- Decorative Elements -->
                    <div class="absolute -bottom-6 -right-6 w-32 h-32 opacity-10 rounded-lg -z-10 bg-gray-500"></div>
                    <div class="absolute -top-6 -left-6 w-24 h-24 border-4 border-gray-500 opacity-20 rounded-lg -z-10"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 lg:py-32">
        <div class="max-w-[1120px] mx-auto px-4">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
                ...
                <!-- Feature 1: Speed -->
                <div>
                    <div class="text-7xl lg:text-8xl font-black text-gray-400 mb-4 leading-none">
                        01
                    </div>
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="relative max-w-[1120px] mx-auto px-4 py-20 lg:py-32">
            <div class="max-w-3xl mx-auto text-center">
                <!-- Small badge -->
                <div class="inline-flex items-center gap-2 backdrop-blur-sm border border-gray-500/50 rounded-full px-4 py-2 mb-8">
                    <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span class="text-sm text-white/90 font-medium">Ready when you are</span>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="<?php echo site_url('packages'); ?>" class="group inline-flex items-center justify-center text-gray-100 px-8 py-4 rounded-full text-base font-bold border border-gray-500 hover:border-gray-400 transition-all shadow-lg hover:shadow-xl hover:scale-105">
                        Get Started Free
